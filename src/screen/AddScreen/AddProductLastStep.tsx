          ...
          <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
            <View style={styles.container}>
              <View style={[styles.box, styles.productPriceContainer]}>
                <View style={styles.tittleContainer}>
                  <View style={{ flexDirection: 'row' }}>
                    <Icon
                      ...
                      color="#FDBD18"
                    />
                    <Heading6 style={[styles.headingText, { paddingLeft: 10 }]}>
                      Giá bán
                    </Heading6>
                  </View>
                ...
                <View style={styles.productRequire}>
                  ...
                  <TextInput
                    ...
                    onChangeText={(value) => handleUpdatePrice(value)}
                ...
                <View style={styles.productRequire}>
                  ...
                  <TextInput
                    ...
                    keyboardType="phone-pad"
                    onChangeText={(value: any) =>
                      setProduct({ ...product, inventory_number: value })
                    }
                    maxFontSizeMultiplier={1}
              ...
              <View
                style={[
                  styles.box,
                  styles.productDescriptionAddContainer,
                  { marginTop: 10 }
                ]}
              >
                <View style={styles.tittleContainer}>
                ...
                <View
                  style={[
                    styles.productOutOfStockDateContainer,
                    styles.shadowStyle
                  ]}
                >
                  <Text
              ...
              <View
                style={[
                  styles.box,
                  styles.productCategoryAddContainer,
                  { marginTop: 10 }
                ]}
              >
                <View style={styles.tittleContainer}>
                ...
                <View style={styles.ownerAddress}>
                  <View style={styles.addressBox}>
                    <TextInput
                      ...
                      onChangeText={(value: any) =>
                        setProduct({ ...product, seller_name: value })
                      }
                      style={{
                        fontSize: 18,
                        marginBottom: 5,
                    ...
                    <TextInput
                      ...
                      onChangeText={(value: any) =>
                        setProduct({ ...product, seller_phone: value })
                      }
                      style={{
                        fontSize: 18,
                        marginBottom: 5,
                ...
                <View style={styles.buttonsGroup}>
                  <View style={styles.bottomContainer}>
                    <Text style={styles.tipsText}>
                      Mẹo: Hãy nhập địa chỉ gửi nông sản của bạn để người mua dễ
                      nhận biết.
                    </Text>
                  </View>
                  <ButtonNormal

...
const ProductDetailScreen = ({ Props, route }: any) => {
  ...
  const checkFollow = (_data: any) => {
    let list = [];
    list.push(
      userInfo?.following?.find((user) => user?.followed_id === _data?.user.id)
    );
        ...
        <View style={styles.container}>
          ...
          <ScrollView>
            <View style={styles.container}>
              <View style={[styles.box, styles.productDetailContainer]}>
                    ...
                    <Avatar
                      ...
                      source={
                        data?.user?.profile_image
                          ? { uri: data?.user?.profile_image_url }
                          : require('../../image/symbol.png')
                      }
                    />
                ...
                >
                  <Text style={[styles.productStatus, { marginBottom: 20 }]}>
                    Mô tả sản phẩm
                  </Text>
                ...
                <View style={[styles.productContainer, styles.productAdjust]}>
                  ...
                  <View style={styles.productStatusItem}>
                    ...
                    <Text style={{ fontSize: 18 }}>
                      {data?.inventory_number ?? '-'} {data?.unit ?? ''}
                    </Text>
                  </View>
                </View>
                <View style={styles.productImageContainer}>
                  <Text
                    style={[styles.productStatus, { alignSelf: 'flex-start' }]}
                  >
                    Ảnh sản phẩm
                  </Text>
                  ...
                  <View style={styles.productStatusItem}>
                    ...
                    >
                      ...
                      />{' '}
                      {routeParams.askedTimes ? routeParams.askedTimes : '0'}{' '}
                      người đang hỏi
                    </Text>
              ...
              <View style={[styles.box, { marginTop: 10 }]}>
                ...
                <View style={styles.userInfomationCounters}>
                  <Text style={{ fontSize: 16 }}>
                    <Heading6>54</Heading6> ngày ở Misao
                  </Text>
                  <Text style={{ fontSize: 16 }}>
                    <Heading6>4</Heading6> đang bán
                  </Text>
                  <Text style={{ fontSize: 16 }}>
                    <Heading6>5</Heading6> đang mua
                  </Text>
                </View>
              </View>
          ...
          {userInfo?.id !== data?.user?.id ? (
            ...
            >
              <TouchableOpacity
                style={{
                  backgroundColor: color.normalButton,
                  alignItems: 'center',
                  justifyContent: 'center',
                  paddingVertical: 10,
                  borderRadius: 5,

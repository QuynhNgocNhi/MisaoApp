...
const handleServerError = (error: AxiosError): ErrorResponse => {
  ...
  if (response && response.status >= 400) {
    if (response.status >= 500) {
      Alert.alert('', 'Hệ thống đang lỗi, vui lòng thử lại sau!', [
        {
          text: 'OK',
          style: 'cancel'
        }
...
export const loginAppAPI = async ({
  phone,
  password
}: ParamsLogin): Promise<Auth | ErrorResponse> => {
  try {
...
export const register = async (
  ...
  try {
    const response = await post<BaseResponse>('/auth/register', {
      ...userInfo,
      confirm: true
    });
    return response.data;
...
export const getMasterDataApi = async (): Promise<
  ObjectResponse<MasterDataResponse> | ErrorResponse
> => {
  try {
    const response = await get<ObjectResponse<MasterDataResponse>>(
...
export const forgetPasswordAPI = async (
  ...
  try {
    const response = await post<BaseResponse>('/auth/forget-password', {
      email
    });
    return response.data;
  } catch (error: any) {
...
export const getMe = async (): Promise<
  ObjectResponse<UserInfo> | ErrorResponse
> => {
  try {
...
export const checkPhoneExistsAPI = async (
  phone: string
): Promise<BaseResponse | ErrorResponse> => {
  try {
...
export const sendOtpRegisterAPI = async (
  phone: string
): Promise<BaseResponse | ErrorResponse> => {
  try {
...
export const resetPasswordAPI = async (
  ...
  try {
    const response = await post<BaseResponse>('/auth/reset-password', {
      phone,
      password,
      otp
    });
...
export const sendOtpResetPasswordAPI = async (
  ...
  try {
    const response = await post<BaseResponse>('/auth/reset-password/otp', {
      phone
    });
    return response.data;
  } catch (error: any) {
...
export const getHotProductListAPI = async (): Promise<
  ListResponse<any> | ErrorResponse
> => {
  try {
...
export const getProductListAPI = async (
  data?: any
): Promise<ListResponse<any> | ErrorResponse> => {
  try {
    const response = await get<ListResponse<any>>(`/product`, {
      params: { ...data }
    });
    return response.data.data;
  } catch (error: any) {
...
export const getPostListAPI = async (
  ...
  try {
    const response = await get<ListResponse<any>>(`/buy-request`, {
      params: { ...data }
    });
    return response.data.data;
  } catch (error: any) {
...
export const getProductDetailAPI = async (
  id?: any
): Promise<ObjectResponse<any> | ErrorResponse> => {
  try {
...
export const addProductAPI = async (
  ...
  try {
    ...
    let out_of_stock_date = `${data.out_of_stock_date?.getDate()}-${
      data.out_of_stock_date?.getMonth() + 1
    }-${data.out_of_stock_date?.getFullYear()}`;
...
export const editProductAPI = async (
  ...
  try {
    ...
    const response = await postFile<any>(
      `/product-manager/${data.id}`,
      formData
    );
...
export const getCharRoomAPI = async (
  type: any
): Promise<ListResponse<any> | ErrorResponse> => {
  try {
    const response = await get<ListResponse<any>>(`/chat`, {
      params: { type }
    });
    return response.data.data;
  } catch (error: any) {
...
export const addPostAPI = async (
  ...
  try {
    ...
    formData.append('description', data?.description);
    formData.append('confirm', true);
    let limited_date = `${data.limited_date?.getDate()}-${
      data.limited_date?.getMonth() + 1
    }-${data.limited_date?.getFullYear()}`;
...
export const sendMessageTextAPI = async (
  chatRoomID: number,
  content: string
): Promise<BaseResponse | ErrorResponse> => {
  try {
    const response = await post<BaseResponse>(`/chat/${chatRoomID}/message`, {
      content
    });
    return response.data;
  } catch (error: any) {
...
export const sendMessageFileAPI = async (
  chatRoomID: number,
  file: string
): Promise<BaseResponse | ErrorResponse> => {
  try {
    ...
    const response = await postFile<BaseResponse>(
...
export const likeProductAPI = async (
  ...
  try {
    const response = await post<BaseResponse>(
      `/product/${product_id}/favorite`,
      {}
    );
    return response.data;
  } catch (error: any) {
...
export const likeBuyRequestAPI = async (
  id: number
): Promise<BaseResponse | ErrorResponse> => {
  try {
    const response = await post<BaseResponse>(
...
export const getHistorySearchAPI = async (): Promise<
  ListResponse<any> | ErrorResponse
> => {
  try {
...
export const getListProductFavoriteAPI = async (): Promise<
  ListResponse<any> | ErrorResponse
> => {
  try {
...
export const getListMyProductAPI = async (): Promise<
  ListResponse<any> | ErrorResponse
> => {
  try {
...
export const getListMyBuyRequestAPI = async (): Promise<
  ListResponse<any> | ErrorResponse
> => {
  try {
...
export const getListBuyRequestFavoriteAPI = async (): Promise<
  ListResponse<any> | ErrorResponse
> => {
  try {
...
export const getListMyNotificationAPI = async (): Promise<
  ListResponse<any> | ErrorResponse
> => {
  try {
...
export const getListOrderAPI = async (): Promise<
  ListResponse<any> | ErrorResponse
> => {
  try {
